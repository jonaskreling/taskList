 ...
 * Task Model
 *
 * @property \App\Model\Table\StatustaskTable|\Cake\ORM\Association\BelongsTo $Statustask
 *
...
class TaskTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['statustask_id'], 'Statustask'));
